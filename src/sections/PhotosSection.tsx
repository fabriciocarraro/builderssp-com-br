    ...
    <section id="fotos" className="section">
      <div className="shell">
        <SectionHeader
          ...
          description="Os primeiros encontros da comunidade Builders SP ainda vão acontecer. Depois de cada edição, esta área vai receber os registros da comunidade."
        />
